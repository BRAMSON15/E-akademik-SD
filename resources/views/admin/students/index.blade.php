            ...
            <tr>
                ...
                <td>
                    <div style="display: flex; gap: 0.5rem;">
                        <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-primary" style="padding: 0.25rem 0.5rem;"><i class="fas fa-edit"></i></a>
                        <form action="{{ route('admin.students.destroy', $student->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus siswa ini?');" style="display:inline;">
                            @csrf
                            @method('DELETE')
