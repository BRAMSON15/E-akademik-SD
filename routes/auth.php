...
Route::middleware('guest')->group(function () {
    ...
    Route::get('parent/register', [\App\Http\Controllers\Auth\ParentRegisterController::class, 'create'])
        ->name('parent.register');

    Route::post('parent/register', [\App\Http\Controllers\Auth\ParentRegisterController::class, 'store'])
